...
- `BLOCKED_CANDIDATES`: List of additional IP addresses / subnets to filter from candidates received by clients. Private / multicast IP addresses are filtered by default (if not allowed above).
