...
const file_grpc_room_proto_rawDesc = "" +
	"\n" +
	"\x0fgrpc_room.proto\x12\tsignaling\"P\n" +
	...
	"\boutgoing\x18\x04 \x01(\x04R\boutgoing2`\n" +
	"\bRpcRooms\x12T\n" +
	"\x10GetRoomBandwidth\x12\x1f.signaling.RoomBandwidthRequest\x1a\x1d.signaling.RoomBandwidthReply\"\x00B<Z:github.com/strukturag/nextcloud-spreed-signaling;signalingb\x06proto3"
...
var file_grpc_room_proto_goTypes = []any{
	(*RoomBandwidthRequest)(nil), // 0: signaling.RoomBandwidthRequest
	(*RoomBandwidthReply)(nil),   // 1: signaling.RoomBandwidthReply
}
var file_grpc_room_proto_depIdxs = []int32{
	0, // 0: signaling.RpcRooms.GetRoomBandwidth:input_type -> signaling.RoomBandwidthRequest
	1, // 1: signaling.RpcRooms.GetRoomBandwidth:output_type -> signaling.RoomBandwidthReply
