...
type GetInternalSessionsRequest struct {
	...
	// Deprecated: Marked as deprecated in grpc/sessions.proto.
...
const file_grpc_sessions_proto_rawDesc = "" +
	...
	"\fProxySession\x12\x1a.grpc.ClientSessionMessage\x1a\x1a.grpc.ServerSessionMessage\"\x00(\x010\x01B7Z5github.com/strukturag/nextcloud-spreed-signaling/grpcb\x06proto3"
...
var file_grpc_sessions_proto_goTypes = []any{
	...
	(*LookupSessionIdRequest)(nil),     // 2: grpc.LookupSessionIdRequest
	(*LookupSessionIdReply)(nil),       // 3: grpc.LookupSessionIdReply
	(*IsSessionInCallRequest)(nil),     // 4: grpc.IsSessionInCallRequest
	(*IsSessionInCallReply)(nil),       // 5: grpc.IsSessionInCallReply
	(*GetInternalSessionsRequest)(nil), // 6: grpc.GetInternalSessionsRequest
	(*InternalSessionData)(nil),        // 7: grpc.InternalSessionData
	(*VirtualSessionData)(nil),         // 8: grpc.VirtualSessionData
