...
const (
	RpcInternal_GetServerId_FullMethodName      = "/grpc.RpcInternal/GetServerId"
	RpcInternal_GetTransientData_FullMethodName = "/grpc.RpcInternal/GetTransientData"
)
