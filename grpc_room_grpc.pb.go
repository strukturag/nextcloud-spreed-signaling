...
const (
	RpcRooms_GetRoomBandwidth_FullMethodName = "/signaling.RpcRooms/GetRoomBandwidth"
)
...
func (UnimplementedRpcRoomsServer) GetRoomBandwidth(context.Context, *RoomBandwidthRequest) (*RoomBandwidthReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRoomBandwidth not implemented")
}
...
func RegisterRpcRoomsServer(s grpc.ServiceRegistrar, srv RpcRoomsServer) {
	// If the following call pancis, it indicates UnimplementedRpcRoomsServer was
...
var RpcRooms_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "signaling.RpcRooms",
