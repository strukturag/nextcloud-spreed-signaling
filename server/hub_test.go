...
func TestGeoipOverrides(t *testing.T) {
	...
	assert.Equal(geoip.Loopback, hub.LookupCountry("127.0.0.1"))
	assert.Equal(geoip.UnknownCountry, hub.LookupCountry("8.8.8.8"))
	assert.EqualValues(country1, hub.LookupCountry("10.1.1.2"))
	assert.EqualValues(country2, hub.LookupCountry("10.2.1.2"))
	assert.EqualValues(strings.ToUpper(country3), hub.LookupCountry("192.168.10.20"))
}
