		...
		case "streams":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonC1cedd36DecodeGithubComStrukturagNextcloudSpreedSignalingV2Sfu(in, &v10)
	...
	if len(in.Streams) != 0 {
		...
		}
		{
			...
			for v11, v12 := range in.Streams {
				...
				easyjsonC1cedd36EncodeGithubComStrukturagNextcloudSpreedSignalingV2Sfu(out, v12)
			}
			out.RawByte(']')
		}
	}
